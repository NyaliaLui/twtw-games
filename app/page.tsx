    ...
    <div className="py-4 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
      ...
      <div className="max-w-2xl mx-auto flex flex-col items-center space-y-4">
        <Link
          ...
          className="w-full sm:w-64 inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900"
        >
          <svg
            className="w-4 h-4"
            aria-hidden="true"
        ...
        <Link
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-full sm:w-64 inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] rounded-lg hover:bg-gradient-to-br focus:ring-4 focus:outline-none dark:focus:ring-pink-800"
        >
          <svg
