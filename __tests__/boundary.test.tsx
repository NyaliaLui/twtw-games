...
describe('Test Snake boundaries', () => {
    it('Renders game boundaries', async () => {
        ...
        const renderer = await ReactThreeTestRenderer.create(<Boundary boundProps={boundProps} />);

        const specificBoundaryProps = (geometry: ChildrenType, material: ChildrenType, props: TestProps) => {
